...
class Knapsack2d_2objs(BinaryProblem):
    ...
    def __init__(
        ...
        super(Knapsack2d_2objs, self).__init__()
        ...
        if from_file:
            ...
            self.profits = normalize(profits, axis=1, norm='l1')
            self.number_of_bits = number_of_workers
            
        self.profits = self.profits * mask
    ...
    def evaluate(self, solution: BinarySolution) -> BinarySolution:
        ...
        solution.objectives[0] = (-1.0 * total_placements) + (-1.0 * round(total_profits,1))
        return solution
