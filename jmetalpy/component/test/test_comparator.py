...
from jmetalpy.core.solution import FloatSolution, Solution
from jmetalpy.component.comparator import Dominance, SolutionAttribute, RankingAndCrowdingDistance
...
class SolutionAttributeComparatorTestCases(unittest.TestCase):
    ...
    def setUp(self):
        self.comparator = SolutionAttribute("attribute")
    ...
    def test_should_compare_works_properly_case3(self):
        ...
        """
        comparator = SolutionAttribute("attribute", False)
        solution1 = Solution(1, 1)
        solution2 = Solution(1, 1)
        solution1.attributes["attribute"] = 0.0
        solution2.attributes["attribute"] = 1.0
...
class RankingAndCrowdingComparatorTestCases(unittest.TestCase):
    ...
    def setUp(self):
        self.comparator = RankingAndCrowdingDistance()
