...
from jmetalpy.component.archive import NonDominatedSolutionList, Bounded, CrowdingDistance, Archive
...
class NonDominatedSolutionListArchiveTestCases(unittest.TestCase):
    ...
    def setUp(self):
        self.archive = NonDominatedSolutionList()
