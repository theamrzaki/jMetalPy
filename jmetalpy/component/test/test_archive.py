...
from jmetalpy.component.archive import NonDominatedSolutionList, Bounded, CrowdingDistance
from jmetalpy.core.solution import Solution


class BoundedArchiveTestCases(unittest.TestCase):
    def setUp(self):
        self.archive = Bounded[Solution](5)
...
class NonDominatedSolutionListTestCases(unittest.TestCase):

    def setUp(self):
        self.archive = NonDominatedSolutionList[Solution]()
...
class CrowdingDistanceTestCases(unittest.TestCase):
    ...
    def test_should_constructor_create_a_non_null_object(self):
        archive = CrowdingDistance[Solution](5)
    ...
    def test_should_add_work_properly_case5(self) :
        ...
        """
        archive = CrowdingDistance[Solution](3)
    ...
    def test_should_add_work_properly_case6(self) :
        ...
        """
        archive = CrowdingDistance[Solution](4)
