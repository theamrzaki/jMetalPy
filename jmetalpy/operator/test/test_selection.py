...
from jmetalpy.operator.selection import BinaryTournament, BestSolution, RandomSolutionSelection, \
...
class BinaryTournament2TestCases(unittest.TestCase):
    ...
    def test_should_execute_work_properly_case1(self):
        ...
        solution_list = [solution1, solution2]
        operator = BinaryTournament2[Solution]([SolutionAttribute("key")])
